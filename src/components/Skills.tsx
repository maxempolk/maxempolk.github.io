  ...
  return (
    <section id="skills" className="py-20 px-6 bg-lighter dark:bg-darker">
        <div className="container mx-auto max-w-6xl">
            <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center text-black dark:text-gray-400">{t('skills_section_title')}</h2>
            <div className="grid md:grid-cols-3 gap-8">
                {skillsContent.categories.map((category) => (
                <div className="bg-light dark:bg-dark p-8 rounded-lg border border-gray-800">
