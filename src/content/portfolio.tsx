import type { IProject } from "./portfolioTypes";
...
export const heroContent = {
  greeting: 'hero.hello_text',
  paragraph: 'hero.paragraph',
  
  ctaProjects: 'hero.view_projects',
  ctaContact: 'hero.contact_me'
};
...
export const contactContent = {
  ...
  contacts: [
    {
      text: "mpolyak7@gmail.com",
      value: "mailto:mpolyak7@gmail.com",
      icon: <svg className="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 20 20">
    ...
    {
      text: "Github",
      value: 'https://github.com/maxempolk',
      icon: <svg className="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 20 20">
    ...
    {
      text: "LinkedIn",
      value: 'https://www.linkedin.com/in/mxmplk-поляк-193839350/',
      icon: <svg className="w-6 h-6 mr-2" fill="currentColor" viewBox="0 0 20 20">
